    ...
    <div class="content">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Nueva Bebida</h3>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group my-2">
                            ...
                            <select class="form-control custom-select" name="cbo_Bebida" required>
                                <option value="">Seleccione</option>
                                @foreach($categoriabebida as $categoriabebidas)
                                <option value="{{$categoriabebidas->id}}">{{$categoriabebidas->categoria_bebida}}
                                </option>
                        ...
                        <div class="form-group my-3 ">
                            ...
                            <input type="text" class="form-control" name="bebida" required>
                        </div>
